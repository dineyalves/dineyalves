...
<p align="center">
  <a href="https://www.linkedin.com/in/valdineyalves/">
    <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=flat-square&logo=linkedin&logoColor=white"/>
  </a>
  <a href="mailto:valdiney.alves03@gmail.com">
...
Sou analista de dados em uma fintech de crédito consignado. Atuo no core da operação — responsável pela ingestão, qualidade e disponibilização de dados, e pela integração de novas ferramentas e IA no ambiente, com foco em eficiência e produtividade do time.
...
- Pipeline redesenhado de **2h+ para menosETL em nuvem com eliminação de etapasredundantes; tabelas e relatórios disponíveis no início do expediente
- Arquitetura Medallion + Parquet: **−70% o refresh** do Power BI Service — viabilizou o uso de todo o histórico da carteira, antes inviável pelo tamanho dos arquivos, e reduziu custo de licenças e
capacidade no Microsoft Fabric
- Importação de convênios: **~13h manuais para ~5 min** — automação em Python com interface visual, validação antes
 do disparo e alertas de erro; adotada por
- Repasse de valores: destravei um gargalo técnico que atrasava o crédito para os clientes no dia de vencimento — a
 automação processa os lotes por vencimentos e sinaliza erros operacionais e atrasosna conciliação
- Desenvolvi uma solução de liquidações ad*Neyliqui** — processa repasses de altovalor em produção mensal e faz parte do fluxo padrão da área
